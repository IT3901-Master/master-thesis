...
\begin{figure}[h]
    ...
    \caption{\textbf{Statement}: "I think my motivation for exchange would increase if Utsida was in use". \textbf{Group:} Students who has \textbf{not} participated in an exchange program (N = 27)}
    \label{fig:test}
...
\begin{figure}[h]
    ...
    \caption{\textbf{Statement:} "I thought it was easy to use Utsida". \\ \textbf{Group:} Students who have \textbf{not} participated in an exchange program (N = 27)}
    \label{fig:test}
...
\begin{figure}[h]
    ...
    \caption{\textbf{Statement:} "I think Utsida would have simplified my application process". \\ \textbf{Group:} Students who have participated in an exchange program (N = 13)}
    \label{fig:test}
...
\begin{figure}
    ...
    \end{tikzpicture}
        ...
        \label{fig:tiger}
    \end{subfigure}
    \caption{\textbf{Statement:} "I think Utsida can contribute to an increased number of students who choose to participate in an exchange program"}
\end{figure}
...
\begin{figure}[h]
    ...
    \end{tikzpicture}
        ...
        \label{d}
    \end{subfigure}
    \caption{Results from question: "How did the recommendation suit the original search parameters?" (N = 40)}
