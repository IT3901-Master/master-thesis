...
This description is based on the process stages at the computer science department at NTNU, it may have some differences between departments. The current process for choosing and approving exchange courses is mostly done manually at NTNU. See Figure \ref{ntnu_process} for a short overview of the whole application process. The boxes in green are the targeted areas of the proposed system. The course approval process is required both before and after an exchange or study abroad period. Course selection also have to be pre-approved before applying for an exchange program.
