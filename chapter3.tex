...
\subsubsection{Offline testing of recommendation}
...
\subsection{Survey}
To answer RQ2, a survey will be conducted. First, a baseline will be established regarding students’ motivation and attitude towards applying for an exchange program at NTNU. This baseline will be created by utilizing a questionnaire which will be sent to a target group of students. These students will then be asked to try Utsida, followed by a new questionnaire which will establish whether the developed system had any substantial positive effect on these students.
